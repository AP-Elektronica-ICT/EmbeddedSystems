...
*---------------------------------------------------------------------------*/
/* Flag Names*/
const uint8_t g_ace_ppe_flag_0_name[] = "TM0_Voltage:over1p0v";
const uint8_t g_ace_ppe_flag_1_name[] = "TM0_Voltage:over1p5v";
const uint8_t g_ace_ppe_flag_2_name[] = "TM0_Voltage:over2p0v";
const uint8_t g_ace_ppe_flag_3_name[] = "TM0_Voltage:over2p5v";
/* Flag Table*/
...
{
	{
        ...
        0,                         /* uint16_t flag_properties default_hysteresis */
